...
public abstract class SpriteRoot : MonoBehaviour, IEZLinkedListItem<ISpriteAnimatable>, IUseCamera
{
	...
	public float GetWorldUnitsPerScreenPixel()
	{
		float result = 0f;
		if (renderCamera != null)
		{
			result = renderCamera.orthographicSize * 2f / screenSize.y;
		}
		return result;
	}
	...
	public void CalcSize()
	{
		...
		if (pixelPerfect)
		{
			worldUnitsPerScreenPixel = TBFUtils.GetUIScaling();
