...
public class SpriteText : MonoBehaviour, IUseCamera
{
	...
	public void CalcSize()
	{
		if (spriteFont != null)
		{
			if (pixelPerfect)
			{
				characterSize = spriteFont.PixelSize;
				worldUnitsPerTexel = worldUnitsPerScreenPixel * TBFUtils.GetInverseUITextScaling();
	...
	public void SetPixelToUV(int texWidth, int texHeight)
	{
		if (spriteFont != null)
		{
			...
			worldUnitsPerTexel = TBFUtils.GetUITextScaling() * characterSize / (float)spriteFont.PixelSize;
