...
public class UIButton : AutoSpriteControlBase
{
	...
	public static bool sInputLocked;
	...
	public MonoBehaviour scriptWithMethodToInvokeWhenDisabled;

	public string methodToInvokeWhenDisabled = string.Empty;
	...
	{
		if (deleted || sInputLocked)
		{
			return;
		}
		if (!IsHidden() && !m_controlIsEnabled)
		{
			if (ptr.evt == POINTER_INFO.INPUT_EVENT.TAP && scriptWithMethodToInvokeWhenDisabled != null)
			{
				scriptWithMethodToInvokeWhenDisabled.Invoke(methodToInvokeWhenDisabled, delay);
			}
