...
public class UIScrollList : MonoBehaviour, IEZDragDrop, IUIObject
{
	...
	protected InputScrollChangeDelegate inputScrollDelegate;
	...
	public void ListDragged(POINTER_INFO ptr)
	{
		...
		if (inputScrollDelegate != null)
		{
			inputScrollDelegate(scrollPos);
		}
		noTouch = false;
		isScrolling = true;
	}
	...
	public void AddInputScrollChangeDelegate(InputScrollChangeDelegate del)
	{
		inputScrollDelegate = (InputScrollChangeDelegate)Delegate.Combine(inputScrollDelegate, del);
	}

	public void RemoveInputScrollChangeDelegate(InputScrollChangeDelegate del)
	{
		inputScrollDelegate = (InputScrollChangeDelegate)Delegate.Remove(inputScrollDelegate, del);
	}
