				...
				if (flag2)
				{
					...
					if (!flag2 && text3.Length > 0)
					{
						if (text3[0] == SLASH)
						{
							...
							{
								XMLNode xMLNode4;
								XMLNode xMLNode3 = (xMLNode4 = xMLNode2);
								string key2;
								string key = (key2 = "_text");
								object obj = xMLNode4[key2];
								xMLNode3[key] = string.Concat(obj, text4);
							}
							text4 = string.Empty;
							text3 = string.Empty;
						...
						{
							XMLNode xMLNode6;
							XMLNode xMLNode5 = (xMLNode6 = xMLNode2);
							string key2;
							string key3 = (key2 = "_text");
							object obj = xMLNode6[key2];
							xMLNode5[key3] = string.Concat(obj, text4);
						}
						text4 = string.Empty;
