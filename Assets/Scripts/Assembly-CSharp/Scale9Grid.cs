	...
	public void Resize()
	{
		...
		for (int i = 0; i < sprites.Length; i++)
		{
			...
			case 6:
				...
				simpleSprite.lowerLeftPixel = new Vector2(0f, num2);
				simpleSprite.pixelDimensions = vector;
				break;
			case 7:
				simpleSprite.width = vector2.x;
				...
				simpleSprite.lowerLeftPixel = new Vector2(num / 2f, num2);
				simpleSprite.pixelDimensions = new Vector2(1f, num2 / 2f);
				break;
			case 8:
				simpleSprite.width = cornerSize;
			...
			simpleSprite.SetSize(simpleSprite.width, simpleSprite.height);
		}
	}
